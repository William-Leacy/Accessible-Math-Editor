...
function distance() {
            ...
            let chosenMeasurment = mesurmentList[Math.floor(Math.random()*mesurmentList.length)];
            ...
            let unitsOfMeasureArea = document.createElement("div");
            let rightSymbolLowerElments = document.createElement("div");
            ...
            unitsOfMeasureArea.setAttribute("class", "columnar-addition-right-symbol-area-container");
            rightSymbolLowerElments.setAttribute("class", "columnar-addition-right-symbol-upper-container");
            rightSymbolLowerElments.innerHTML=chosenMeasurment;
            ...
            outerLayer.appendChild(unitsOfMeasureArea);
            unitsOfMeasureArea.appendChild(rightSymbolLowerElments);
            ...
            for (let i =0; i < numbers.length; i++) {
                rightSymbolUpperElments[i] = document.createElement("div");
                rightSymbolUpperElments[i].setAttribute("id", (equationID + "symbol-element" + i));
                rightSymbolUpperElments[i].setAttribute("class", "columnar-addition-right-symbol-lower-container");
                unitsOfMeasureArea.appendChild(rightSymbolUpperElments[i]);
                rightSymbolUpperElments[i].innerHTML=chosenMeasurment;
